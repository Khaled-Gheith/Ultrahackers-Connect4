...
int main(){
    ...
    while(!isBoardFull(board)){
        ...
        updateBoard(entry, 1);
        if(winningMove()){
            winner = playerHavingRed;
            printf("Congrats %s, you\'re the winner!",playerHavingRed);
            break;
        }
        timeTakenByPlayerHavingRed += (double)(end-start);
        ...
        timeTakenByPlayerHavingYellow += (double)(end-start);
    }
    if(isBoardFull()){
